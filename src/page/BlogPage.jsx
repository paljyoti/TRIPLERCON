...
const BlogPage = () => {
  ...
  />
  <div className="absolute inset-0 flex flex-col justify-center items-start text-left p-4 sm:p-8 md:p-16 lg:p-28 bg-black bg-opacity-50">
    <p className="text-[#39FF14] font-bold text-lg sm:text-2xl md:text-4xl lg:text-5xl uppercase tracking-wide mb-1 sm:mb-2">
      blog
    </p>
    <h1 className="text-white text-base sm:text-lg md:text-2xl lg:text-3xl font-bold">
      ...
      <div className="bg-white min-h-screen p-6 md:p-16 lg:p-28">
        <header className="mb-8 md:mb-12">
          <h1 className="text-3xl md:text-4xl font-bold text-[#39FF14] text-center">
            Welcome to the Blog
          </h1>
        </header>
