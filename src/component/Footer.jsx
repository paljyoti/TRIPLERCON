  ...
  return (
    <div className="bg-black text-white py-10 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 pl-20">
        ...
        <h1 className="text-lg font-semibold mb-2 text-left text-[#39FF14]">Triple R Consulting</h1>
        ...
        <div className="add">
          <h1 className="text-lg font-semibold mb-2 text-left text-[#39FF14]">Address</h1>
          <p className="text-lg text-left mt-5 ">
        ...
        <div className="menu ">
          <h1 className="text-lg font-semibold mb-2 text-left text-[#39FF14]">Our Menu</h1>
        ...
        <div className="top">
          <h1 className="text-lg font-semibold mb-2 text-left text-[#39FF14]">Top Links</h1>
          <ul className="space-y-1 mt-5 text-left">
      ...
      <div className="text-center mt-12">
        <p className="text-lg text-left pl-20 text-[#39FF14]">
